...
saveWhere = 'plots/new_4x8vs4x4E3H3/EffTau4x8'+selection+'RlxVeto'+str(TauVetoRlx)+'Apply4x4TauVeto'+str(Veto4x4)+'OffIso'+str(turnOffIso)+'OffVeto'+str(turnOffTauVeto)+'Iso'+str(ISOTHRESHOLD)
if Cmp4x4 == False:
        saveWhere = 'plots/new_ECAL3HCAL3/EffTau4x8'+selection+'RlxVeto'+str(TauVetoRlx)+'OffIso'+str(turnOffIso)+'OffVeto'+str(turnOffTauVeto)+'Iso'+str(ISOTHRESHOLD)
...
########
#Efficiency
eff_ntuple = 'tau_efficiency_4x8_new_calibrations_July28.root'
...
# UCT Relaxed
 if drawUCTRlx_:
  ...
  cut_uctR_1=recoPtCut+'&&'+l1gPtCut+'&&l1gMatch'+vetoCut
  rlxLegendStr_1 = 'UCT (4x8): Rlx (With Tau Veto)'
  h_UCT_rlx_1=effi_histo(ntuple_rlx,variable,cut_uctR_1,binning,denom_rlx,
  rlxLegendStr_1,legend,
  ROOT.EColor.kMagenta,markerUR,log)
  h_UCT_rlx_1.SetName('h_UCT_rlx_1')
  h_UCT_rlx_1.Write()
