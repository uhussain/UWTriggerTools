...
compare_pt_offset(jet_ntuple,

# Resolutions
jet_ntuple.Draw("(recoPt - (l1gPt))/recoPt>>l1gPtRes(150, -2, 1)", "l1gMatch && recoPt > 30 && abs(recoEta) < 3.0", "goff")
...
jet_ntuple.Draw("recoPt-l1gPt:nPVs>>l1g","recoPt>40 &&recoPt<50 && recoEta<3.0 && l1gMatch","BOX")
l1g = ROOT.gDirectory.Get("l1g")
l1g.SetLineColor(ROOT.EColor.kBlue)
l1g.SetTitle('Upgrade Corr Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple.Draw("recoPt-l1Pt:nPVs>>l1","recoPt>40 &&recoPt<50 && recoEta<3.0 && l1Match","BOX")
l1 = ROOT.gDirectory.Get("l1")
l1.SetLineColor(ROOT.EColor.kRed)
l1.SetTitle('Current Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple_uncorr.Draw("recoPt-l1gPt:nPVs>>l1gu","recoPt>40 &&recoPt<50 && recoEta<3.0 && l1gMatch","BOX")
l1gu = ROOT.gDirectory.Get("l1gu")
l1gu.SetLineColor(ROOT.EColor.kMagenta)
l1gu.SetTitle('Uncorr Upgrade Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
profilel1gu.Draw()
profilel1gu.SetTitle('Average (Reco Pt)-(Trigger Pt) Difference vs PU (40<recoPT<50)')
profilel1gu.GetYaxis().SetRangeUser(-10.0,25.0)
profilel1gu.GetXaxis().SetTitle('nPVs')
profilel1gu.GetYaxis().SetTitle('Average RecoPt-TriggerPt')
profilel1.Draw("same")
...
legend1.AddEntry(profilel1gu, "Unorrected UCT Jet")
legend1.Draw("same")
saveas=saveWhere+'profilePU4050.png'
canvas.SaveAs(saveas)
...
jet_ntuple.Draw("recoPt-l1gPt:nPVs>>l1g","recoPt>50 &&recoPt<60 && recoEta<3.0 && l1gMatch","BOX")
l1g = ROOT.gDirectory.Get("l1g")
l1g.SetLineColor(ROOT.EColor.kBlue)
l1g.SetTitle('Upgrade Corr Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple.Draw("recoPt-l1Pt:nPVs>>l1","recoPt>50 &&recoPt<60 && recoEta<3.0 && l1Match","BOX")
l1 = ROOT.gDirectory.Get("l1")
l1.SetLineColor(ROOT.EColor.kRed)
l1.SetTitle('Current Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple_uncorr.Draw("recoPt-l1gPt:nPVs>>l1gu","recoPt>50 &&recoPt<60 && recoEta<3.0 && l1gMatch","BOX")
l1gu = ROOT.gDirectory.Get("l1gu")
l1gu.SetLineColor(ROOT.EColor.kMagenta)
l1gu.SetTitle('Uncorr Upgrade Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
profilel1gu.Draw()
profilel1gu.SetTitle('Average (Reco Pt)-(Trigger Pt) Difference vs PU (50<recoPT<60)')
profilel1gu.GetYaxis().SetRangeUser(-10.0,25.0)
profilel1gu.GetXaxis().SetTitle('nPVs')
profilel1gu.GetYaxis().SetTitle('Average RecoPt-TriggerPt')
profilel1.Draw("same")
...
legend1.AddEntry(profilel1gu, "Unorrected UCT Jet")
legend1.Draw("same")
saveas=saveWhere+'profilePU5060.png'
canvas.SaveAs(saveas)
...
jet_ntuple.Draw("recoPt-l1gPt:nPVs>>l1g","recoPt>60 &&recoPt<70 && recoEta<3.0 && l1gMatch","BOX")
l1g = ROOT.gDirectory.Get("l1g")
l1g.SetLineColor(ROOT.EColor.kBlue)
l1g.SetTitle('Upgrade Corr Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple.Draw("recoPt-l1Pt:nPVs>>l1","recoPt>60 &&recoPt<70 && recoEta<3.0 && l1Match","BOX")
l1 = ROOT.gDirectory.Get("l1")
l1.SetLineColor(ROOT.EColor.kRed)
l1.SetTitle('Current Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
jet_ntuple_uncorr.Draw("recoPt-l1gPt:nPVs>>l1gu","recoPt>60 &&recoPt<70 && recoEta<3.0 && l1gMatch","BOX")
l1gu = ROOT.gDirectory.Get("l1gu")
l1gu.SetLineColor(ROOT.EColor.kMagenta)
l1gu.SetTitle('Uncorr Upgrade Trigger Pt vs PU')
#l1g.GetXaxis().SetTitle("nPVs")
...
profilel1gu.Draw()
profilel1gu.SetTitle('Average (Reco Pt)-(Trigger Pt) Difference vs PU (60<recoPT<70)')
profilel1gu.GetYaxis().SetRangeUser(-10.0,25.0)
profilel1gu.GetXaxis().SetTitle('nPVs')
profilel1gu.GetYaxis().SetTitle('Average RecoPt-TriggerPt')
profilel1.Draw("same")
...
legend1.AddEntry(profilel1gu, "Unorrected UCT Jet")
legend1.Draw("same")
saveas=saveWhere+'profilePU6070.png'
canvas.SaveAs(saveas)
