...
class puMultipTree : public edm::EDAnalyzer {
	public:
		explicit puMultipTree(const edm::ParameterSet& pset);
...
puMultipTree::puMultipTree(const edm::ParameterSet& pset) 
{
...
void puMultipTree::analyze(const edm::Event& evt, const edm::EventSetup& es) {
...
DEFINE_FWK_MODULE(puMultipTree);
