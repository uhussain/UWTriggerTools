...
class puMultipTreeEdit : public edm::EDAnalyzer {
	public:
		explicit puMultipTreeEdit(const edm::ParameterSet& pset);
...
puMultipTreeEdit::puMultipTreeEdit(const edm::ParameterSet& pset) 
{
...
void puMultipTreeEdit::analyze(const edm::Event& evt, const edm::EventSetup& es) {
...
DEFINE_FWK_MODULE(puMultipTreeEdit);
